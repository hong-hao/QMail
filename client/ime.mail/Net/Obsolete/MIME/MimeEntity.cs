		...
		public DateTime Date
		{
			get{ 
				if(m_pHeader.Contains("Date:")){
					try{
						return ime.mail.Net.MIME.MIME_Utils.ParseRfc2822DateTime(m_pHeader.GetFirst("Date:").Value);
					}
					catch{
			...
			set{ 
				if(m_pHeader.Contains("Date:")){
					m_pHeader.GetFirst("Date:").Value = ime.mail.Net.MIME.MIME_Utils.DateTimeToRfc2822(value);
				}
				else{
